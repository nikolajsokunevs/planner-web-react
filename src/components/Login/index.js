...
class Login extends Component {
  ...
  goToCreateAccountPage() {
    ReactDOM.render(<UserRegistration />, document.getElementById("root"));
  }
          ...
          <div className="account-card-content">
            <form className="form-horizontal m-t-30">
              <InputFormComponent
                label="Username"
                type="input"
                className={this.errorClass(this.state.fields.login.valid)}
                name="login"
        ...
        <div className="m-t-40 text-center">
          <p>
            ...
            <a
              ...
              onClick={this.goToCreateAccountPage}
            >
              {" "}
              Sign up!
            </a>
